...
int main(int argc,const char *argv[]){
    ...
    lru.set('k',10);
    std::cout<<"--------"<<endl;
    std::cout<<lru.get('a')<<endl;
    std::cout<<lru.get('b')<<endl;
    std::cout<<lru.get('c')<<endl;
    std::cout<<lru.get('d')<<endl;
    std::cout<<lru.get('e')<<endl;
    std::cout<<"--------"<<endl;
    std::cout<<lru.get('f')<<endl;
    std::cout<<lru.get('g')<<endl;
    std::cout<<lru.get('h')<<endl;
    std::cout<<lru.get('i')<<endl;
    std::cout<<lru.get('k')<<endl;
    return 0;       
}
